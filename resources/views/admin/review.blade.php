...
@section('content')
    <main class="pt-20">
        ...
        <div class="w-full bg-gray-100 pt-4 px-0 lg:px-28 relative" id="quick-info">
            ...
            <button class="flex items-center text-white bg-violet-500 rounded-full cursor-pointer absolute -bottom-3 hidden add-after" data-id="0" title="add component after" style="left:8.5rem;">
