    ...
    public function run(): void
    {
        ...
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             'bookmaker_id' => 1,
             'component' => 'h2',
             'value_en' => '{"0":"Conclusion"}',
             'value_es' => '{"0":"Conclusión"}',
             'value_fr' => '{"0":"Conclusion"}',
             'value_pt' => '{"0":"Conclusão"}',
             'order' => 32
            ]
        );
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             'bookmaker_id' => 1,
             'component' => 'p',
             'value_en' => '{"0":"1XBET offers its clients attractive bonus offers that increase interest in betting and help boost players’ potential winnings. The first deposit bonus allows new players to start playing with a solid bankroll, while the free bet enables risk-free wagers on sporting events. These bonuses demonstrate 1XBET’s commitment to providing comfortable conditions for its users and rewarding their activity on the platform. Thanks to such attractive offers, the bookmaker strengthens its reputation as a reliable and customer-oriented brand in the world of sports betting."}',
             'value_es' => '{"0":"1XBET ofrece a sus clientes atractivas ofertas de bonos que aumentan el interés en las apuestas y ayudan a incrementar las ganancias potenciales de los jugadores. El bono por el primer depósito permite a los nuevos jugadores comenzar a jugar con un capital sólido, mientras que la apuesta gratuita permite realizar apuestas sin riesgo en eventos deportivos. Estos bonos demuestran el compromiso de 1XBET de proporcionar condiciones cómodas a sus usuarios y recompensar su actividad en la plataforma. Gracias a estas atractivas ofertas, la casa de apuestas fortalece su reputación como una marca confiable y orientada al cliente en el mundo de las apuestas deportivas."}',
             'value_fr' => '{"0":"1XBET propose à ses clients des offres de bonus attractives qui augmentent l’intérêt pour les paris et aident à accroître les gains potentiels des joueurs. Le bonus sur le premier dépôt permet aux nouveaux joueurs de commencer à jouer avec un capital solide, tandis que le pari gratuit permet de faire des mises sans risque sur des événements sportifs. Ces bonus démontrent l’engagement de 1XBET à offrir des conditions confortables à ses utilisateurs et à récompenser leur activité sur la plateforme. Grâce à ces offres attractives, le bookmaker renforce sa réputation de marque fiable et orientée client dans le monde des paris sportifs."}',
             'value_pt' => '{"0":"1XBET oferece aos seus clientes ofertas de bônus atraentes que aumentam o interesse pelas apostas e ajudam a aumentar os ganhos potenciais dos jogadores. O bônus no primeiro depósito permite que novos jogadores comecem a jogar com um capital sólido, enquanto a aposta grátis possibilita apostas sem risco em eventos esportivos. Esses bônus demonstram o compromisso da 1XBET em fornecer condições confortáveis para seus usuários e recompensar sua atividade na plataforma. Graças a essas ofertas atraentes, a casa de apostas fortalece sua reputação como uma marca confiável e orientada ao cliente no mundo das apostas esportivas."}',
             'order' => 33
            ]
        );
    }
